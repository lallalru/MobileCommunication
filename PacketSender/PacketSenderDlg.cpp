...
u_char* CPacketSenderDlg::attachReqItems() // (첫번째 과제)
{
	u_char temp[93] = {
		...
		// Item1 id-NAS-PDU
		///////////////////////////// Fill in the blank. ////////////////////////////////////////
		0x00,0x1a,0x00,0x35,0x34,0x17,0x7c,0x2a,0x01,0x33,0x06,0x07,0x41 /* modify value */,0x51,0x0b,0xf6
...
{
	u_char temp[64] = {
		//item0 MME-UE-S1AP-ID
		0x00, 0x00, 0x00, 0x03, 0x40, 0x12, 0x86,

		//item1  id-eNB-UE-S1AP-ID
		0x00, 0x08, 0x00, 0x02, 0x00, 0x00,

		//item2 -> 0x00을 0x53으로 기입
		0x00,0x1a,0x00,0x12,0x11,0x17,0x38,
		0x6f,0x95,0x5b,0x08,0x07,0x53, /*modify type to 0x53*/ 0x08,0xaa,
		0x7a,0xdf,0x21,0x9c,0xa2,0x52,0x82,

		//item3 id-EUTRAN-CGI
		0x00,0x64,0x40,0x08,0x00,0x54,0xf0,
		0x60, 0x00, 0x00, 0x10, 0xe0,		
